    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToursSight", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ToursSight_Sight_SightId",
                        column: x => x.SightId,
                        principalTable: "Sight",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ToursSight_Tour_TourId",
                        column: x => x.TourId,
                        principalTable: "Tour",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToursSight_SightId",
                table: "ToursSight",
                column: "SightId");

            migrationBuilder.CreateIndex(
                name: "IX_ToursSight_TourId",
                table: "ToursSight",
                column: "TourId");
        }
